...
const projects = [
  {
    ...
    description: 'A modern e-commerce solution built with React, Node.js, and MongoDB. Features include real-time inventory, secure payments, and admin dashboard.',
  ...
  },
  {
    ...
    description: 'Responsive portfolio website with Three.js animations, smooth scrolling, and dynamic content management.',
