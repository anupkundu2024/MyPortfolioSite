...
export function RotatingBadge({ size = 120, className = "" }) {
  return (
    ...
    >
      ...
      {/* Rotating SVG circular text (CSS animation, runs on the compositor) */}
      <svg
        viewBox="0 0 160 160"
        className="w-full h-full text-foreground/80 drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)] animate-badge-spin"
      >
        <defs>
          <path
            id="circlePath"
